...
import { App, Button, Select, Table, Tag, Tooltip } from 'antd';
import {
    CheckCircle,
    Clock,
    PackageCheck,
...
export default function StockTransfersPage() {
    ...
    const fetchRequests = useCallback(async () => {
        ...
        try {
            ...
            // Small timeout to ensure the standardized loader is visible and transition is smooth
        ...
        },
        {
            ...
            render: (status: TransferRequest['status']) => {
                ...
                return (
                    <Tag
                        color={cfg.color}
                        className="inline-flex items-center justify-center gap-1.5 px-3 py-1 rounded-full font-medium"
                    >
    ...
    return (
        <div className="flex flex-1 flex-col gap-6 p-4">
                        ...
                        ...Object.entries(statusConfig).map(([value, cfg]) => ({
                            ...
                            label: (
                                <div className="flex items-center gap-2">
                                    <cfg.icon className="h-4 w-4 text-[var(--text-muted)]" />
                                    <span>{cfg.label}</span>
                                </div>
                            ),
                        })),
            ...
            <div className="flex-1 relative min-h-[400px]">
                {loading && <LoadingDots fullScreen />}
